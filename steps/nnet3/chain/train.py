...
sys.path.append("/apdcephfs/share_1157259/users/janinezhao/kaldi/egs/vkw_ddt/s5//steps/")
vkw="/apdcephfs/share_1157259/users/janinezhao/kaldi/egs/vkw_ddt/s5/"
...
def train(args, run_opts):
    ...
    common_lib.execute_command(vkw+"/utils/split_data.sh {0} {1}"
    ...
    common_lib.execute_command(vkw+"/steps/info/chain_dir_info.pl "
                               "{0}".format(args.dir))
